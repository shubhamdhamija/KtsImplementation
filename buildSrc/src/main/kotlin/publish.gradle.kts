    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/shubhamdhamija/ktsimplementation/")
                ...
                developers {
                    developer {
                        id.set("shubhamdhamija")
                        name.set("shubhamdhamija")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/shubhamdhamija/ktsimplementation.git")
                    developerConnection.set("scm:git:ssh://github.com/shubhamdhamija/ktsimplementation.git")
                    url.set("https://github.com/shubhamdhamija/ktsimplementation/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/shubhamdhamija/ktsimplementation/issues")
                }
            }
        }
    }
